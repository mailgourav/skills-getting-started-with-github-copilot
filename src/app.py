...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team to practice and compete in matches",
    ...
    "School Band": {
        "description": "Play instruments and prepare music for school events",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["sophia@mergington.edu", "mason@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and argument skills through debates",
        "schedule": "Mondays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["olivia@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Study science concepts and compete in academic challenges",
